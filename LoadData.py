...
def add_to_truck(package_to_sort_id):
    ...
    if package_to_sort.deadline != 'EOD':
        ...
        if 'Truck' in package_to_sort.special:
            ...
            if int(package_to_sort_id) not in truck_1.truck_packages and int(package_to_sort_id) not in truck_2.truck_packages and int(package_to_sort_id) not in must_go_with_truck1:
...
for element_id in sorted(not_sorted_packages):
    package_to_sort = package_hashtable.get(element_id)
    ...
    if int(package_to_sort.package_id) not in truck_1.truck_packages and int(package_to_sort.location_id) in truck_2.truck_locations:
...
#print(sorted(truck_1.truck_packages))
#print("Truck 1 locations: ")
#print(truck_1.truck_locations)
#print()
